...
class lscodecHandler(StreamHandler):
    def __init__(
        self,
        url: str,
...
def main():
    ...
    parser.add_argument("--url", type=str, help="URL to lscodec server.")
    ...
    with gr.Blocks() as demo:
        ...
        <div style='text-align: center'>
            <h1>
                Talk To lscodec (Powered by WebRTC ⚡️)
            </h1>
            <p>
