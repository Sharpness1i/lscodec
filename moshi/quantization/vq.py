...
from .base import BaseQuantizer, QuantizedResult,QuantizedResult_distill
...
class SplitResidualVectorQuantizer(BaseQuantizer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.rvq_first = ResidualVectorQuantizer(
            n_q=n_q_semantic, force_projection=True, q_dropout=True, **kwargs
        )
    ...
    def forward(self, x: torch.Tensor, teacher_features:torch.Tensor, frame_rate: int):
        ...
        cos_sim = F.cosine_similarity(semantic_embed, teacher_features_pool, dim=-1)   # => (B, T)
        cos_dist = 1 - cos_sim #  
